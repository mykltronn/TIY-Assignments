...
( function() {
  "use strict";
   ...
   console.assert(date == "Sun Aug 24 2008 23:30:00 GMT-0400 (EDT)", "#1: Test failed. It returned: " + date)
} )();
...
pet.dogLover = likesDogs(pet.dogLover = 'Dan');
...
(function() {
  ...
  var explain = function () {
    ...
    return teacher + " " + "explains to" + " " + name + " " + "that two plus two equals" + " " + math();
  }
  ...
  console.assert(explain() == "The teacher explains to Mary that two plus two equals 4", "#9: Test failed. Check scope and hoisting")
})();
